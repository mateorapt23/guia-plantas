  ...
  try {
    ...
    if (existing) {
      ...
      if (existing.role !== 'ADMIN') {
        ...
        console.log('Rol actualizado a ADMIN para el usuario id', existing.id);
      } else {
        console.log('El usuario ya tiene rol ADMIN, no se hizo nada.');
      }
    } else {
    ...
    console.log('\nRecomendado: cambia esta contraseña después del primer login.');
